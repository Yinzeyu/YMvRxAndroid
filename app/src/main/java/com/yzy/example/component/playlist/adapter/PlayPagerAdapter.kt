...
import com.yzy.example.component.playlist.view.PagerItemView
...
import kotlinx.android.synthetic.main.item_play_pager_parent.view.*
...
class PlayPagerAdapter(list: List<VideoBean>) : PagerAdapter() {
  ...
  fun fillData(
    ...
    viewHolder.mThumb?.load(
        url = videoBean.thumb,
        placeholderId = R.drawable.place_holder_video_9_16,
