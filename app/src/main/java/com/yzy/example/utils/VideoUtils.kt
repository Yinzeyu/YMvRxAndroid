...
class VideoUtils private constructor() {
  //输出文件目录
  private val outParentVideo = com.blankj.utilcode.util.PathUtils.getExternalAppDataPath() + File.separator + "video"
  //产生的封面保存地址
  private val outParentImgs = com.blankj.utilcode.util.PathUtils.getExternalAppDataPath() + File.separator + "temp"
