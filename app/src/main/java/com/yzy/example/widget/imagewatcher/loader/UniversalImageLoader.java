 ...
 */
public class UniversalImageLoader implements com.yzy.example.widget.imagewatcher.loader.ImageLoader {
    private Context context;
    private DisplayImageOptions normalImageOptions;
    private Map<String, com.yzy.example.widget.imagewatcher.loader.ImageLoader.SourceCallback> callbackMap;
