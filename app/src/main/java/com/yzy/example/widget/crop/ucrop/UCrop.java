package com.yzy.example.widget.crop.ucrop;
...
import com.yzy.example.widget.crop.ucrop.model.AspectRatio;
...
public class UCrop {
  ...
  public static class Options {
    ...
    public static final String EXTRA_CROP_FRAME_STROKE_WIDTH =
        EXTRA_PREFIX + ".CropFrameStrokeWidth";
    ...
    public static final String EXTRA_UCROP_COLOR_WIDGET_ACTIVE =
        EXTRA_PREFIX + ".UcropColorWidgetActive";
