...
import com.yzy.example.extention.BOTTOM_LEFT
import com.yzy.example.extention.BOTTOM_RIGHT
import com.yzy.example.extention.TOP_LEFT
import com.yzy.example.extention.TOP_RIGHT
...
class CommonShapeTextView @JvmOverloads constructor(
     ...
     * 是否居中对齐
     */
    private var csbTxtGravity = false
    ...
    init {
        context.obtainStyledAttributes(attrs, R.styleable.CommonShapeButton).apply {
            ...
            csbTxtGravity = getBoolean(R.styleable.CommonShapeButton_csb_txtGravity, false)
    ...
    public fun setColorBg(color: Int) {
        mFillColor = color
        invalidate()
        requestLayout()
    }
