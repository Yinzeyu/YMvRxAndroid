...
import com.yzy.example.widget.crop.ucrop.callback.BitmapLoadCallback;
import com.yzy.example.widget.crop.ucrop.model.ExifInfo;
import com.yzy.example.widget.crop.ucrop.util.BitmapLoadUtils;
import com.yzy.example.widget.crop.ucrop.util.FastBitmapDrawable;
...
public class TransformImageView extends AppCompatImageView {
   ...
   */
  void setImageUri(@NonNull final Uri imageUri, @Nullable final Uri outputUri) throws Exception {
    //新的图片loading
    //new BitmapLoadingWorkerTask(imageUri, new OnLoadFinishListener() {
    //  @Override public void loadFinish(ResultLoad resultLoad) {
    //    if (resultLoad.error == null) {
    //      mImageInputPath = imageUri.getPath();
    //      if (outputUri != null) {
    ...
    //      mBitmapDecoded = true;
    //
    //      setImageBitmap(resultLoad.bitmap);
    //    } else {
    //      if (mTransformImageListener != null) {
    //        mTransformImageListener.onLoadFailure(resultLoad.error);
    //      }
    //    }
    //  }
    //}).execute();
