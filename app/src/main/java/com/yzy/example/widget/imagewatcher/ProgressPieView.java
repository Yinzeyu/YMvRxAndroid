...
public class ProgressPieView extends View {
    ...
    private ProgressPieView.OnProgressListener mListener;
    ...
    private ProgressPieView.AnimationHandler mAnimationHandler = new ProgressPieView.AnimationHandler();
     ...
     */
    public void setOnProgressListener(ProgressPieView.OnProgressListener listener) {
        mListener = listener;
    }
