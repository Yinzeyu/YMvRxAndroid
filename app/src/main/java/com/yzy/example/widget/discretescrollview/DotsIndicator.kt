package com.yzy.example.widget.discretescrollview
...
class DotsIndicator : LinearLayout {
    ...
    private var dotSize: Int = SizeUtils.dp2px(7f)
    private var lastDotSize: Int = SizeUtils.dp2px(14f)
    private var marginsBetweenDots: Int = SizeUtils.dp2px(8f)
    private var selectedDotScaleFactor: Float = 1.4f
    private var selectedDotResource: Int = R.drawable.circle_accent
    private var unselectedDotResource: Int = R.drawable.circle_primary
    private var firstSelectedDotResource: Int = R.drawable.ic_home_white_24dp
    private var firstUnselectedDotResource: Int = R.drawable.ic_home_gray_24dp
    private var needSpecial: Boolean = false//是否需要特殊处理最后一个
