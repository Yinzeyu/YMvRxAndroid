...
public class CameraSurface extends SurfaceView implements SensorController.CameraFocusListener,
  ...
  private boolean flashLightAvailable() {
    return isPreviewing() && getContext().getPackageManager()
  ...
  void handleFocusMetering(float originFocusCenterX, float originFocusCenterY, int originFocusWidth,
    int originFocusHeight) {
    try {
