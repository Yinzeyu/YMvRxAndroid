...
object BridgeUtil {
    internal const val YY_OVERRIDE_SCHEMA = "yy://"
    //格式为   yy://return/{function}/returncontent
    internal const val YY_RETURN_DATA = YY_OVERRIDE_SCHEMA + "return/"
    private const val YY_FETCH_QUEUE = YY_RETURN_DATA + "_fetchQueue/"
    private const val EMPTY_STR = ""
    internal const val UNDERLINE_STR = "_"
    private const val SPLIT_MARK = "/"
    internal const val CALLBACK_ID_FORMAT = "JAVA_CB_%s"
    internal const val JS_HANDLE_MESSAGE_FROM_JAVA =
        "javascript:WebViewJavascriptBridge._handleMessageFromNative('%s');"
    internal const val JS_FETCH_QUEUE_FROM_JAVA =
